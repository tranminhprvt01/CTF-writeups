...
def go(sock):
    sock.settimeout(300) # No response for 60s then connection will be closed.
    ...
    while True:
        ...
        if com == 0: # Meaning that connection is closed
            ...
            tag = sock.recv(16)
            print(character.nickname, character.day, character.stamina, character.intelligence, character.friendship, "before enc")
