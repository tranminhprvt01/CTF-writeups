...
def create_pok(v, s, F):
    ...
    print("debug", [list(FF).index(i[0]) for i in list(com) + list(v) + list(verif)], a, a*s, t-a*s)
...
F = []
"""
if we were given the seed, we can manually recover F
"""
