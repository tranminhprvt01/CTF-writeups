...
print(_plus1(_plus1(1)))


(lambda _0: _0(input))(lambda _1: (lambda _2: _2('Enter the flag: '))(lambda _3: (lambda _4: _4(_1(_3)))))
"""
...
ct = '16_10_13_x_6t_4_1o_9_1j_7_9_1j_1o_3_6_c_1o_6r'
res = [chr(int(i, 36) + 10) for i in ct.split('_')]

print(res)

res = ''.join(res)
res = [chr(123 ^ ord(i)) for i in res]

print(res)

res = ''.join(res)
res = [chr(ord(i) - 3) for i in res]

print(res)

res = ''.join(res)
res = [chr(ord(i) + 12) for i in res]
